...
import com.laszlobogacsi.albimester.bills.elmu.ElmuBillHeader.ElmuBillHeaderBuilder;
import com.laszlobogacsi.albimester.bills.elmu.ElmuBillItems.ElmuBillItemsBuilder;
...
public class ElmuBillParserTest {
    ...
    void canParseElmuBillWithMissingBuyerAddress() throws IOException {
        ...
        Bill expectedElmuBill = ElmuBill.builder()
                .header(buildBillHeaderWithoutBuyerAddress().build())
                .items(buildBillItems().build())
                .summary(buildBillSummary().build())
                .build();
    ...
    void canParseElmuBillWithMissingSellerAddress() throws IOException {
        ...
        Bill expectedElmuBill = ElmuBill.builder()
                .header(buildBillHeaderWithoutSellerAddress().build())
                .items(buildBillItems().build())
                .summary(buildBillSummary().build())
                .build();
    ...
    private ElmuBillHeaderBuilder buildBillHeader() {
    ...
    private ElmuBillHeaderBuilder buildBillHeaderWithoutBuyerAddress() {
        return ElmuBillHeader.builder()
                .sellerInfo(buildSellerInfo().build())
                .buyerInfo(buildBuyerInfo().address(null).build())
                .invoiceInfo(buildInvoiceInfo().build());
    }

    private ElmuBillHeaderBuilder buildBillHeaderWithoutSellerAddress() {
        return ElmuBillHeader.builder()
                .sellerInfo(buildSellerInfo().address(null).build())
                .buyerInfo(buildBuyerInfo().build())
                .invoiceInfo(buildInvoiceInfo().build());
    }
    ...
    private ElmuBillItemsBuilder buildBillItems() {
